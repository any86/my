...
var afterRoateXY_1 = require("./afterRoateXY");
var calcRect = function (width, height, angle) {
    ...
    points.forEach(function (point) {
        var _a = afterRoateXY_1.default({ x: point.x, y: point.y, angle: angle, centerX: 0, centerY: 0 }), x = _a.x, y = _a.y;
        console.log({ x: x, y: y });
...
exports.default = (function (img, angle) {
